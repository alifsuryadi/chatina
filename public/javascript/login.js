...
document.getElementById('feature-button').addEventListener('click', function(e) {
  e.preventDefault();
  openPopup();
});

// Tangani klik pada ikon close
document.getElementById('close-popup').addEventListener('click', closePopup);

// Call lsRememberMe function when the form is submitted
